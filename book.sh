...
ebook-convert the-power-of-perception-how-to-create-a-personal-brand-that-makes-an-impact.epub the-power-of-perception-how-to-create-a-personal-brand-that-makes-an-impact.docx --no-chapters-in-toc --chapter-mark=none --disable-markup-chapter-headings --docx-no-toc --docx-no-cover --docx-page-size=a5 --extra-css page_styles.css
